    ...
    public function render_preview(moodle_page $page) {
        ...
        if($options['allowselfassessment']) {
        	$module = array('name'=>'gradingform_rubric', 'fullpath'=>'/grade/grading/form/rubric/js/rubric.js');
					...
					$page->requires->js_init_call('M.gradingform_rubric.setup_selfassessment', array(array('definition' => $this->definition->id, 'api' => $CFG->wwwroot . '/grade/grading/form/rubric/js/api.php')), true, $module);
        }
...
class gradingform_rubric_instance extends gradingform_instance {
    ...
    public function render_grading_element($page, $gradingformelement) {
        ...
        if (!$gradingformelement->_flagFrozen) {
            ...
            $page->requires->js_init_call('M.gradingform_rubric.init', array(array('name' => $gradingformelement->getName(), 'api' => $CFG->wwwroot . '/grade/grading/form/rubric/js/api.php')), true, $module);
